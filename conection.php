...
*/
    ...
    $user= 'guille'; /* aca se puede modificar el nombre de usuario para facilitar acceso*/
    $contraseña= '123'; /* aca se puede modificar el nombre de contraseña para facilitar acceso*/
